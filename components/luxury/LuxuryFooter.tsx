    ...
    <footer className="bg-black text-white py-20 px-8 border-t border-white/5">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-16">
        <div className="max-w-sm">
          <div className="flex items-center gap-2 mb-8">
            <div className="w-6 h-6 bg-white rounded-sm flex items-center justify-center">
              <span className="text-black font-serif font-bold text-sm leading-none">E</span>
            </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-12 sm:gap-24">
          <div>
            <h4 className="text-[10px] uppercase tracking-widest text-white/30 font-bold mb-6">Navigation</h4>
          ...
          <div>
            <h4 className="text-[10px] uppercase tracking-widest text-white/30 font-bold mb-6">Admin</h4>
            <ul className="space-y-4 text-sm font-light text-white/60">
              <li><a href="/admin" className="hover:text-white transition-colors">CRM Login</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Security</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Support</a></li>
            </ul>
          </div>
          <div className="col-span-2 sm:col-span-1">
            <h4 className="text-[10px] uppercase tracking-widest text-white/30 font-bold mb-6">Contact</h4>
      ...
      <div className="max-w-7xl mx-auto mt-20 pt-10 border-t border-white/5 flex justify-between items-center text-[10px] uppercase tracking-[0.2em] text-white/20">
